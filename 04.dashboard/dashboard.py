...
st.subheader( 'Interactive Dashboard to Exploratory Data Analysis' )
...
# distribution of properties by commercial categories
...
if __name__ == "__main__":
    # ETL
    path = 'https://raw.githubusercontent.com/pmusachio/house_rocket/main/00.datasets/kc_house_data.csv'
